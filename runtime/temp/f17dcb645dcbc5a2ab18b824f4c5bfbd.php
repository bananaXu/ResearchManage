<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:102:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\public/../application/admin\view\dynamic\dynamic_list.html";i:1540898871;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\admin\view\public\base.html";i:1501913354;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\admin\view\public\meta.html";i:1538812279;s:85:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\admin\view\public\header.html";i:1539226549;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\admin\view\public\menu.html";i:1540897959;s:85:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\admin\view\public\footer.html";i:1540896626;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<form action="<?php echo url('dynamic/dynamicList'); ?>" method="get">
				<div class="cl pd-5 bg-1 bk-gray mt-20">
					...
					<a href="javascript:;" onclick="dynamic_add('成员动态信息','<?php echo url("admin/dynamic/dynamicAdd"); ?>','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe642;</i> 添加动态信息</a> 
					</span>
				</div>
			</form>
			<div class="mt-5">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<?php if(is_array($arrylist) || $arrylist instanceof \think\Collection || $arrylist instanceof \think\Paginator): $i = 0; $__LIST__ = $arrylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr class="text-c">
							...
							<td class="td-manage">
								<?php if($vo['enable'] == '1'): ?>
								<a style="text-decoration:none" onClick="dynamic_stop(this,<?php echo $vo['id']; ?>)" href="javascript:;" title="停用">
									<i class="Hui-iconfont">&#xe631;</i>
								</a>
								<?php else: ?>
								<a style="text-decoration:none" onClick="dynamic_start(this,<?php echo $vo['id']; ?>)" href="javascript:;" title="启用">
									<i class="Hui-iconfont">&#xe615;</i>
								</a>
								<?php endif; ?>
								<a href="javascript:;" onclick="dynamic_edit('成员动态编辑','<?php echo url("admin/dynamic/dynamicEdit",["id"=>$vo["id"]]); ?>','1','800','500')" class="ml-5" style="text-decoration:none">
									<i class="Hui-iconfont">&#xe6df;</i>
								</a>
							</td>
						</tr>
...
function dynamic_stop(obj,id){
	...
	layer.confirm('确认要停用吗？',function(index){
		...
		$.get("<?php echo url('dynamic/setStatus'); ?>",{id:id});
...
function startAll()
{
	layer.confirm('确认要全部启用吗？',function(index){
		...
		for(var i=cks.length-1; i>=0; i--){
			if(cks[i].checked==true){
				var id = cks[i].id;
				$.get("<?php echo url('dynamic/startAll'); ?>",{id:id})
