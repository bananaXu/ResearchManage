<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:100:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\public/../application/admin\view\member\member_edit.html";i:1542186489;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\admin\view\public\base.html";i:1501913354;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\admin\view\public\meta.html";i:1541999460;s:85:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\admin\view\public\footer.html";i:1540896626;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<form action="<?php echo url("admin/member/editMember"); ?>", method="post" enctype="multipart/form-data" target="nm_iframe" class="form form-horizontal" id="form-member-edit">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input  type="text" class="input-text" value="<?php echo $member_info['name']; ?>" placeholder="" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>姓名拼音：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input  type="text" class="input-text" value="<?php echo $member_info['spell']; ?>" placeholder="" id="spell" name="spell">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:100px;">
				<select class="select" name="education" size="1">
					<option value="0"<?php if($member_info['education'] == 0){echo 'selected="selected"';} ?>>本科生</option>
					<option value="1"<?php if($member_info['education'] == 1){echo 'selected="selected"';} ?>>硕士生</option>
					<option value="2"<?php if($member_info['education'] == 2){echo 'selected="selected"';} ?>>副教授</option>
					<option value="3"<?php if($member_info['education'] == 3){echo 'selected="selected"';} ?>>教授</option>
				</select>
				</span>
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input  type="text" class="input-text" value="<?php echo $member_info['grade']; ?>" placeholder="" id="grade" name="grade">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input  type="text" class="input-text" value="<?php echo $member_info['contact']; ?>" placeholder="" id="contact" name="contact">
			</div>
		</div>			
		<div class="row cl">
...
<script>
document.getElementById("intro").value="<?php echo str_replace(PHP_EOL, '\r\n', $member_info['intro']);?>";
document.getElementById("hobbies").value="<?php echo str_replace(PHP_EOL, '\r\n', $member_info['hobbies']);?>";
document.getElementById("achievement").value="<?php echo str_replace(PHP_EOL, '\r\n', $member_info['achievement']);?>";
</script>
