<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:99:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\public/../application/index\view\download\download.html";i:1541493785;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\index\view\public\base.html";i:1539847680;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\index\view\public\meta.html";i:1541999379;s:85:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\index\view\public\header.html";i:1541906147;s:85:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\index\view\public\footer.html";i:1540963913;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<?php if(is_array($arrylist) || $arrylist instanceof \think\Collection || $arrylist instanceof \think\Paginator): $i = 0; $__LIST__ = $arrylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					...
					<td><a title="下载" href="downloadfile?filename=upload/<?php echo $vo['filename']; ?>.<?php echo $vo['filetype']; ?>" class="text-decoration:none"><i class="Hui-iconfont">&#xe640;</i></a>&nbsp;&nbsp;<a title="预览" href="javascript:;" onclick="Media('资料预览','/index/download/media/fileName/<?php echo $vo['filename']; ?>/fileType/<?php echo $vo['filetype']; ?>','1','900','600')" class="text-decoration:none"><i class="Hui-iconfont">&#xe695;</i></a>
					</td>
				</tr>
...
function getAjaxData(){
	$.ajax({
		type: "POST",
		url: "<?php echo url('ajaxSearchresbyCates'); ?>",
