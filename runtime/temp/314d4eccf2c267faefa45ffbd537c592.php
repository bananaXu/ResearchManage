<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:91:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\public/../application/index\view\task\task.html";i:1542023709;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\index\view\public\base.html";i:1539847680;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\index\view\public\meta.html";i:1541999379;s:85:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\index\view\public\header.html";i:1541906147;s:85:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\index\view\public\footer.html";i:1540963913;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<title><?php echo (isset($title) && ($title !== '')?$title:'任务进度'); ?></title>
...
<div class="container" style="width: 960px; background-color: white; min-height: 700px;">
	<form action="<?php echo url('task/taskList'); ?>" method="get">
		<div class="cl pd-5 bg-1 bk-gray mt-0">
			<span class="l">
			<a href="javascript:;" onclick="addTasks('任务信息','<?php echo url("task/taskAdd"); ?>','800','500')" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe637;</i> 任务发起</a>
			</span>
		</div>
	</form>
	<div class="mt-5">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<?php if(is_array($arrylist) || $arrylist instanceof \think\Collection || $arrylist instanceof \think\Paginator): $i = 0; $__LIST__ = $arrylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					...
					<td class="td-manage">
						<?php if($vo['principal'] == \think\Session::get('user_info.realname')): ?>
						<a title="任务跟进" href="javascript:;" onclick="task_edit('任务跟进','<?php echo url("task/taskEdit",["id"=>$vo["id"]]); ?>','1','800','500')" class="text-decoration:none"><i class="Hui-iconfont">&#xe63d;</i></a>
						&nbsp;
						<?php endif; ?>
