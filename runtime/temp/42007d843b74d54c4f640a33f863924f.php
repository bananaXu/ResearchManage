<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:97:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\public/../application/index\view\dynamic\dynamic.html";i:1541494178;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\index\view\public\base.html";i:1539847680;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\index\view\public\meta.html";i:1541999379;s:85:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\index\view\public\header.html";i:1541906147;s:85:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\index\view\public\footer.html";i:1540963913;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="mt-15">
		<div class="teamDiv">
			<table class="table-sort">
				<?php if(is_array($dynamic) || $dynamic instanceof \think\Collection || $dynamic instanceof \think\Paginator): $k = 0; $__LIST__ = $dynamic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
				<tr>
				...
				<div class="news" id="<?php echo $k; ?>">
					...
					<p>
						...
						<span class="ago"> <?php echo $vo['name']; ?>&nbsp;&nbsp;</span>|
						<span class="ago"> 发布时间&nbsp;&nbsp;<?php echo $vo['time']; ?></span>|
					</p>
				</div>
				</td>
				</tr>
