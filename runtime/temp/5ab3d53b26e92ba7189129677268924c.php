<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:100:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\public/../application/admin\view\member\member_list.html";i:1542000395;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\admin\view\public\base.html";i:1501913354;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\admin\view\public\meta.html";i:1541999460;s:85:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\admin\view\public\header.html";i:1539226549;s:83:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\admin\view\public\menu.html";i:1541989646;s:85:"C:\myphp_www\PHPTutorial\WWW\ResearchManage\application\admin\view\public\footer.html";i:1540896626;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<form action="<?php echo url('member/memberList'); ?>" method="get">
				<div class="cl pd-5 bg-1 bk-gray mt-20">
					...
					<a href="javascript:;" onclick="member_add('成员信息','<?php echo url("admin/member/memberAdd"); ?>','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe642;</i> 添加成员</a> 
					</span>
				</div>
			</form>
			<div class="mt-5">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<?php if(is_array($arrylist) || $arrylist instanceof \think\Collection || $arrylist instanceof \think\Paginator): $i = 0; $__LIST__ = $arrylist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr class="text-c">
							<td><input type="checkbox" value="<?php echo $vo['photoname']; ?>" id="<?php echo $vo['id']; ?>" name="check"></td>
							<td><?php echo $vo['id']; ?></td>
							<td><?php echo $vo['name']; ?></td>
							<td><?php echo $vo['sex']; ?></td>
							<td><?php echo $vo['photoname']; ?></td>
							...
							<td class="td-manage">
								...
								<?php endif; ?>
								<a title="编辑" href="javascript:;" onclick="member_edit('成员编辑','<?php echo url("admin/member/memberEdit",["id"=>$vo["id"]]); ?>','1','800','500')" class="ml-5" style="text-decoration:none">
									<i class="Hui-iconfont">&#xe6df;</i>
								</a>
							</td>
						</tr>
...
function member_stop(obj,id){
	...
	layer.confirm('确认要停用吗？',function(index){
		...
		$.get("<?php echo url('member/setStatus'); ?>",{id:id});
	...
	layer.confirm('确认要全部停用吗？',function(index){
		...
		for(var i=cks.length-1; i>=0; i--){
			if(cks[i].checked==true){
				var id = cks[i].id;
				$.get("<?php echo url('member/stopAll'); ?>",{id:id})
				$("#"+id).parents("tr").find(".td-manage").html('<a onClick=\"member_start(this,\'+id+\')\" href=\"javascript:;\" title=\"启用\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe615;</i></a><a title=\"编辑\" href=\"javascript:;\" onclick=\"member_edit(\'成员编辑\',\'<?php echo url("member/memberEdit",["id"=>$vo["id"]]); ?>\',\'1\',\'800\',\'500\')\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i></a>');
...
function startAll()
{
	layer.confirm('确认要全部启用吗？',function(index){
		...
		for(var i=cks.length-1; i>=0; i--){
			if(cks[i].checked==true){
				var id = cks[i].id;
				$.get("<?php echo url('member/startAll'); ?>",{id:id})
				$("#"+id).parents("tr").find(".td-manage").html('<a onClick=\"member_stop(this,\'+id+\')\" href=\"javascript:;\" title=\"停用\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe631;</i></a><a title=\"编辑\" href=\"javascript:;\" onclick=\"member_edit(\'成员编辑\',\'<?php echo url("member/memberEdit",["id"=>$vo["id"]]); ?>\',\'1\',\'800\',\'500\')\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i></a>');
