<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"D:\myphp_www\PHPTutorial\WWW\pt5\public/../application/admin\view\news\news_edit.html";i:1539136346;s:72:"D:\myphp_www\PHPTutorial\WWW\pt5\application\admin\view\public\base.html";i:1501913354;s:72:"D:\myphp_www\PHPTutorial\WWW\pt5\application\admin\view\public\meta.html";i:1538812279;s:74:"D:\myphp_www\PHPTutorial\WWW\pt5\application\admin\view\public\footer.html";i:1538838424;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="cl pd-20">
	...
	<form action="<?php echo url("admin/news/editNews"); ?>", method="post" enctype="multipart/form-data" target="nm_iframe" class="form form-horizontal" id="form-news-edit">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>新闻标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input  type="text" class="input-text" value="<?php echo $news_info['title']; ?>" placeholder="" id="title" name="title">
			</div>
		</div>		
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea type="text" class="textarea radius" placeholder="请输入简介信息..." id="content" name="content"></textarea>
			</div>
		</div>	
		<div class="row cl">
...
<script>
document.getElementById("content").value="<?php echo $news_info['content']; ?>";
</script>
