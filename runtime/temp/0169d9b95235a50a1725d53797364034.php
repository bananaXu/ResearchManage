<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"D:\myphp_www\PHPTutorial\WWW\pt5\public/../application/admin\view\task\task_edit.html";i:1539609071;s:72:"D:\myphp_www\PHPTutorial\WWW\pt5\application\admin\view\public\base.html";i:1501913354;s:72:"D:\myphp_www\PHPTutorial\WWW\pt5\application\admin\view\public\meta.html";i:1538812279;s:74:"D:\myphp_www\PHPTutorial\WWW\pt5\application\admin\view\public\footer.html";i:1538838424;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="cl pd-20">
	...
	<form action="<?php echo url("admin/task/editTask"); ?>", method="post" enctype="multipart/form-data" target="nm_iframe" class="form form-horizontal" id="form-task-edit">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input  type="text" class="input-text disabled" value="<?php echo $task_info['creator']; ?>" placeholder="" id="creator" name="creator">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>创建时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input  type="text" class="input-text disabled" value="<?php echo $task_info['ctime']; ?>" placeholder="" id="ctime" name="ctime">
			</div>
		</div>	
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:80px;">
				<select class="select" name="state" size="1">
					...
					<option value="3"<?php if($task_info['state'] == 3){echo 'selected="selected"';} ?>>验收</option>
					<option value="4"<?php if($task_info['state'] == 4){echo 'selected="selected"';} ?>>已完成</option>
				</select>
				</span>
			</div>
		</div>
