<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:87:"D:\myphp_www\PHPTutorial\WWW\pt5\public/../application/admin\view\task\task_detail.html";i:1539691162;s:72:"D:\myphp_www\PHPTutorial\WWW\pt5\application\admin\view\public\base.html";i:1501913354;s:72:"D:\myphp_www\PHPTutorial\WWW\pt5\application\admin\view\public\meta.html";i:1538812279;s:74:"D:\myphp_www\PHPTutorial\WWW\pt5\application\admin\view\public\header.html";i:1539226549;s:72:"D:\myphp_www\PHPTutorial\WWW\pt5\application\admin\view\public\menu.html";i:1539416998;s:74:"D:\myphp_www\PHPTutorial\WWW\pt5\application\admin\view\public\footer.html";i:1538838424;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<form action="<?php echo url('task/taskDetail'); ?>" method="get">
					...
					<?php if(is_array($detail_list) || $detail_list instanceof \think\Collection || $detail_list instanceof \think\Paginator): $i = 0; $__LIST__ = $detail_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr class="text-c">
							...
							<td>	
								...
								<span class="label label-success radius">验收</span>
							...
							<td class="td-manage">
								<?php if($vo['enable'] == '1'): ?>
								<a style="text-decoration:none" onClick="taskDtl_stop(this,<?php echo $vo['id']; ?>)" href="javascript:;" title="停用">
									<i class="Hui-iconfont">&#xe631;</i>
								</a>
								<?php else: ?>
								<a style="text-decoration:none" onClick="taskDtl_start(this,<?php echo $vo['id']; ?>)" href="javascript:;" title="启用">
									<i class="Hui-iconfont">&#xe615;</i>
								</a>
								<?php endif; ?>
							</td>
...
function taskDtl_stop(obj,id){
	...
	layer.confirm('确认要停用吗？',function(index){
		...
		$.get("<?php echo url('task/setStatusDtl'); ?>",{id:id});
	...
	layer.confirm('确认要全部停用吗？',function(index){
		...
		for(var i=cks.length-1; i>=0; i--){
			if(cks[i].checked==true){
				var id = cks[i].id;
				$.get("<?php echo url('task/stopAllDtl'); ?>",{id:id})
...
function startAll()
{
	layer.confirm('确认要全部启用吗？',function(index){
		...
		for(var i=cks.length-1; i>=0; i--){
			if(cks[i].checked==true){
				var id = cks[i].id;
				$.get("<?php echo url('task/startAllDtl'); ?>",{id:id})
